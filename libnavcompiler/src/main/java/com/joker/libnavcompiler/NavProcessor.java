package com.joker.libnavcompiler;
...
@SupportedAnnotationTypes({"com.joker.libnavannotation.FragmentDestination", "com.joker.libnavannotation.ActivityDestination"})
